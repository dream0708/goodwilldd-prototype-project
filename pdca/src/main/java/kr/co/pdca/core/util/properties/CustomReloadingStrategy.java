package kr.co.pdca.core.util.properties;
...
public class CustomReloadingStrategy implements ReloadingStrategy {
	...
	public CustomReloadingStrategy() {
		
	}
	
	public CustomReloadingStrategy(long sec) {
		this.refreshDelay = sec;
	}
	...
	private String getName(File file) {
		...
		if (name == null) {
			if (file != null) {
				...
				name = "base: " + configuration.getBasePath() + "file: "
