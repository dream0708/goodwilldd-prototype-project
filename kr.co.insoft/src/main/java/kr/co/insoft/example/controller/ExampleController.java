...
public class ExampleController {
	...
	@RequestMapping("/test")
	public String test(Model model, Example exam) {
		exampleService.doInsertExampleJPA(exam);
	...
	@RequestMapping("/json1/{seq}")
	@ResponseBody
	public Example json1(Model model, @PathVariable long seq) {
		return exampleService.getExam1(seq);
	}
