...
public class PezDatabaseHelper {
	...
	private static class DatabaseHelper extends SQLiteOpenHelper {
		...
		public DatabaseHelper(Context context) {
			this(context, PezDatabaseConstans.DB_NAME, null,
					PezDatabaseConstans.DB_VERSION);
		}
		...
		public void onCreate(SQLiteDatabase db) {
			...
			generateDatabaseQuery.append(TBL_MENUS.TBL_MENUS);
			generateDatabaseQuery.append(" (");
			generateDatabaseQuery.append(TBL_MENUS.MENUS_ID
					+ " INTEGER PRIMARY KEY AUTOINCREMENT");
			generateDatabaseQuery.append(",");
			generateDatabaseQuery.append(TBL_MENUS.MENUS_VERSION);
			generateDatabaseQuery.append(",");
			generateDatabaseQuery.append(TBL_MENUS.MENUS_LINK + " text");
			generateDatabaseQuery.append(",");
			generateDatabaseQuery.append(TBL_MENUS.MENUS_NAME + " text");
			generateDatabaseQuery.append(",");
			generateDatabaseQuery.append(TBL_MENUS.MENUS_ORDER + " text");
			generateDatabaseQuery.append(",");
			generateDatabaseQuery.append(TBL_MENUS.MENUS_ICON + " text");
			generateDatabaseQuery.append(");");
	...
	public void doDeleteAllMenus() {
		...
		db.beginTransaction();
		try {
			db.delete(TBL_MENUS.TBL_MENUS, null, null);
			db.setTransactionSuccessful();
		} finally {
			db.endTransaction();
			close();
